...
####TABLE OF CONTENTS
ALIGNMENT: STAR
5HMC ANALYSIS:PEAK CALLING:MACS
RNASEQ ANALYSIS:DIFFERENTIAL EXPRESSION:CUFFDIFF
RNASEQ ANALYSIS:DIFFERENTIAL EXPRESSION:DESEQ2
RNASEQ ANALYSIS:DIFFERENTIAL SPLICING:CUFFDIFF
RNASEQ ANALYSIS:DIFFERENTIAL SPLICING:DESEQ2/DEXSEQ
PARCE OUT REGIONS OF 5HMC, EXPRESSION, AND ISOFORM REGULATION:BEDTOOLS
ANNOTATION ANALYSIS:HOMER
MOTIF ANALYSIS:HOMER:MOTIF ID AND LOCALIZATION
5HMC ENRICHMENT ANALYSIS:HOMER:HISTOGRAMS AND SCATTERPLOTS: MOTIFS, PROMOTERS, EXONS, INTRONS, EXONS-INTRONS, CTCF, OTHER GENOMIC REGIONS (CPG ISLANDS, EXONS, LNCRNA, PSEUDOGENES, LOW COMPLEXITY REGIONS, SIMPLE REPEATS, SINES, SATELLITES
5HMC AND ALTERNATIVE SPLICING

FAST ANALYSIS: ANNOTATING REGIONS OF THE GENOME BASED ON DISEASE RELEVANT SNP CONTENT
